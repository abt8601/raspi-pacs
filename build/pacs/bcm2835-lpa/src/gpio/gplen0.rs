...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn len0(&mut self) -> LEN0_W<GPLEN0_SPEC> {
        LEN0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Low detect enabled 1"]
    #[inline(always)]
    #[must_use]
    pub fn len1(&mut self) -> LEN1_W<GPLEN0_SPEC> {
        LEN1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Low detect enabled 2"]
    #[inline(always)]
    #[must_use]
    pub fn len2(&mut self) -> LEN2_W<GPLEN0_SPEC> {
        LEN2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Low detect enabled 3"]
    #[inline(always)]
    #[must_use]
    pub fn len3(&mut self) -> LEN3_W<GPLEN0_SPEC> {
        LEN3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Low detect enabled 4"]
    #[inline(always)]
    #[must_use]
    pub fn len4(&mut self) -> LEN4_W<GPLEN0_SPEC> {
        LEN4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Low detect enabled 5"]
    #[inline(always)]
    #[must_use]
    pub fn len5(&mut self) -> LEN5_W<GPLEN0_SPEC> {
        LEN5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Low detect enabled 6"]
    #[inline(always)]
    #[must_use]
    pub fn len6(&mut self) -> LEN6_W<GPLEN0_SPEC> {
        LEN6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Low detect enabled 7"]
    #[inline(always)]
    #[must_use]
    pub fn len7(&mut self) -> LEN7_W<GPLEN0_SPEC> {
        LEN7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Low detect enabled 8"]
    #[inline(always)]
    #[must_use]
    pub fn len8(&mut self) -> LEN8_W<GPLEN0_SPEC> {
        LEN8_W::new(self, 8)
    }
    #[doc = "Bit 9 - Low detect enabled 9"]
    #[inline(always)]
    #[must_use]
    pub fn len9(&mut self) -> LEN9_W<GPLEN0_SPEC> {
        LEN9_W::new(self, 9)
    }
    #[doc = "Bit 10 - Low detect enabled 10"]
    #[inline(always)]
    #[must_use]
    pub fn len10(&mut self) -> LEN10_W<GPLEN0_SPEC> {
        LEN10_W::new(self, 10)
    }
    #[doc = "Bit 11 - Low detect enabled 11"]
    #[inline(always)]
    #[must_use]
    pub fn len11(&mut self) -> LEN11_W<GPLEN0_SPEC> {
        LEN11_W::new(self, 11)
    }
    #[doc = "Bit 12 - Low detect enabled 12"]
    #[inline(always)]
    #[must_use]
    pub fn len12(&mut self) -> LEN12_W<GPLEN0_SPEC> {
        LEN12_W::new(self, 12)
    }
    #[doc = "Bit 13 - Low detect enabled 13"]
    #[inline(always)]
    #[must_use]
    pub fn len13(&mut self) -> LEN13_W<GPLEN0_SPEC> {
        LEN13_W::new(self, 13)
    }
    #[doc = "Bit 14 - Low detect enabled 14"]
    #[inline(always)]
    #[must_use]
    pub fn len14(&mut self) -> LEN14_W<GPLEN0_SPEC> {
        LEN14_W::new(self, 14)
    }
    #[doc = "Bit 15 - Low detect enabled 15"]
    #[inline(always)]
    #[must_use]
    pub fn len15(&mut self) -> LEN15_W<GPLEN0_SPEC> {
        LEN15_W::new(self, 15)
    }
    #[doc = "Bit 16 - Low detect enabled 16"]
    #[inline(always)]
    #[must_use]
    pub fn len16(&mut self) -> LEN16_W<GPLEN0_SPEC> {
        LEN16_W::new(self, 16)
    }
    #[doc = "Bit 17 - Low detect enabled 17"]
    #[inline(always)]
    #[must_use]
    pub fn len17(&mut self) -> LEN17_W<GPLEN0_SPEC> {
        LEN17_W::new(self, 17)
    }
    #[doc = "Bit 18 - Low detect enabled 18"]
    #[inline(always)]
    #[must_use]
    pub fn len18(&mut self) -> LEN18_W<GPLEN0_SPEC> {
        LEN18_W::new(self, 18)
    }
    #[doc = "Bit 19 - Low detect enabled 19"]
    #[inline(always)]
    #[must_use]
    pub fn len19(&mut self) -> LEN19_W<GPLEN0_SPEC> {
        LEN19_W::new(self, 19)
    }
    #[doc = "Bit 20 - Low detect enabled 20"]
    #[inline(always)]
    #[must_use]
    pub fn len20(&mut self) -> LEN20_W<GPLEN0_SPEC> {
        LEN20_W::new(self, 20)
    }
    #[doc = "Bit 21 - Low detect enabled 21"]
    #[inline(always)]
    #[must_use]
    pub fn len21(&mut self) -> LEN21_W<GPLEN0_SPEC> {
        LEN21_W::new(self, 21)
    }
    #[doc = "Bit 22 - Low detect enabled 22"]
    #[inline(always)]
    #[must_use]
    pub fn len22(&mut self) -> LEN22_W<GPLEN0_SPEC> {
        LEN22_W::new(self, 22)
    }
    #[doc = "Bit 23 - Low detect enabled 23"]
    #[inline(always)]
    #[must_use]
    pub fn len23(&mut self) -> LEN23_W<GPLEN0_SPEC> {
        LEN23_W::new(self, 23)
    }
    #[doc = "Bit 24 - Low detect enabled 24"]
    #[inline(always)]
    #[must_use]
    pub fn len24(&mut self) -> LEN24_W<GPLEN0_SPEC> {
        LEN24_W::new(self, 24)
    }
    #[doc = "Bit 25 - Low detect enabled 25"]
    #[inline(always)]
    #[must_use]
    pub fn len25(&mut self) -> LEN25_W<GPLEN0_SPEC> {
        LEN25_W::new(self, 25)
    }
    #[doc = "Bit 26 - Low detect enabled 26"]
    #[inline(always)]
    #[must_use]
    pub fn len26(&mut self) -> LEN26_W<GPLEN0_SPEC> {
        LEN26_W::new(self, 26)
    }
    #[doc = "Bit 27 - Low detect enabled 27"]
    #[inline(always)]
    #[must_use]
    pub fn len27(&mut self) -> LEN27_W<GPLEN0_SPEC> {
        LEN27_W::new(self, 27)
    }
    #[doc = "Bit 28 - Low detect enabled 28"]
    #[inline(always)]
    #[must_use]
    pub fn len28(&mut self) -> LEN28_W<GPLEN0_SPEC> {
        LEN28_W::new(self, 28)
    }
    #[doc = "Bit 29 - Low detect enabled 29"]
    #[inline(always)]
    #[must_use]
    pub fn len29(&mut self) -> LEN29_W<GPLEN0_SPEC> {
        LEN29_W::new(self, 29)
    }
    #[doc = "Bit 30 - Low detect enabled 30"]
    #[inline(always)]
    #[must_use]
    pub fn len30(&mut self) -> LEN30_W<GPLEN0_SPEC> {
        LEN30_W::new(self, 30)
    }
    #[doc = "Bit 31 - Low detect enabled 31"]
    #[inline(always)]
    #[must_use]
    pub fn len31(&mut self) -> LEN31_W<GPLEN0_SPEC> {
        LEN31_W::new(self, 31)
    }
