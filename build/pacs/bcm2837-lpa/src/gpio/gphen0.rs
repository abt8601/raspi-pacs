...
pub type HEN10_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN11_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN12_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN13_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN14_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN15_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN16_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN17_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN18_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN19_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN20_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN21_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN22_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN23_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN24_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN25_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN26_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN27_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN28_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN29_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN30_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type HEN31_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hen0(&mut self) -> HEN0_W<GPHEN0_SPEC> {
        HEN0_W::new(self, 0)
    }
    #[doc = "Bit 1 - High detect enabled 1"]
    #[inline(always)]
    #[must_use]
    pub fn hen1(&mut self) -> HEN1_W<GPHEN0_SPEC> {
        HEN1_W::new(self, 1)
    }
    #[doc = "Bit 2 - High detect enabled 2"]
    #[inline(always)]
    #[must_use]
    pub fn hen2(&mut self) -> HEN2_W<GPHEN0_SPEC> {
        HEN2_W::new(self, 2)
    }
    #[doc = "Bit 3 - High detect enabled 3"]
    #[inline(always)]
    #[must_use]
    pub fn hen3(&mut self) -> HEN3_W<GPHEN0_SPEC> {
        HEN3_W::new(self, 3)
    }
    #[doc = "Bit 4 - High detect enabled 4"]
    #[inline(always)]
    #[must_use]
    pub fn hen4(&mut self) -> HEN4_W<GPHEN0_SPEC> {
        HEN4_W::new(self, 4)
    }
    #[doc = "Bit 5 - High detect enabled 5"]
    #[inline(always)]
    #[must_use]
    pub fn hen5(&mut self) -> HEN5_W<GPHEN0_SPEC> {
        HEN5_W::new(self, 5)
    }
    #[doc = "Bit 6 - High detect enabled 6"]
    #[inline(always)]
    #[must_use]
    pub fn hen6(&mut self) -> HEN6_W<GPHEN0_SPEC> {
        HEN6_W::new(self, 6)
    }
    #[doc = "Bit 7 - High detect enabled 7"]
    #[inline(always)]
    #[must_use]
    pub fn hen7(&mut self) -> HEN7_W<GPHEN0_SPEC> {
        HEN7_W::new(self, 7)
    }
    #[doc = "Bit 8 - High detect enabled 8"]
    #[inline(always)]
    #[must_use]
    pub fn hen8(&mut self) -> HEN8_W<GPHEN0_SPEC> {
        HEN8_W::new(self, 8)
    }
    #[doc = "Bit 9 - High detect enabled 9"]
    #[inline(always)]
    #[must_use]
    pub fn hen9(&mut self) -> HEN9_W<GPHEN0_SPEC> {
        HEN9_W::new(self, 9)
    }
    #[doc = "Bit 10 - High detect enabled 10"]
    #[inline(always)]
    #[must_use]
    pub fn hen10(&mut self) -> HEN10_W<GPHEN0_SPEC> {
        HEN10_W::new(self, 10)
    }
    #[doc = "Bit 11 - High detect enabled 11"]
    #[inline(always)]
    #[must_use]
    pub fn hen11(&mut self) -> HEN11_W<GPHEN0_SPEC> {
        HEN11_W::new(self, 11)
    }
    #[doc = "Bit 12 - High detect enabled 12"]
    #[inline(always)]
    #[must_use]
    pub fn hen12(&mut self) -> HEN12_W<GPHEN0_SPEC> {
        HEN12_W::new(self, 12)
    }
    #[doc = "Bit 13 - High detect enabled 13"]
    #[inline(always)]
    #[must_use]
    pub fn hen13(&mut self) -> HEN13_W<GPHEN0_SPEC> {
        HEN13_W::new(self, 13)
    }
    #[doc = "Bit 14 - High detect enabled 14"]
    #[inline(always)]
    #[must_use]
    pub fn hen14(&mut self) -> HEN14_W<GPHEN0_SPEC> {
        HEN14_W::new(self, 14)
    }
    #[doc = "Bit 15 - High detect enabled 15"]
    #[inline(always)]
    #[must_use]
    pub fn hen15(&mut self) -> HEN15_W<GPHEN0_SPEC> {
        HEN15_W::new(self, 15)
    }
    #[doc = "Bit 16 - High detect enabled 16"]
    #[inline(always)]
    #[must_use]
    pub fn hen16(&mut self) -> HEN16_W<GPHEN0_SPEC> {
        HEN16_W::new(self, 16)
    }
    #[doc = "Bit 17 - High detect enabled 17"]
    #[inline(always)]
    #[must_use]
    pub fn hen17(&mut self) -> HEN17_W<GPHEN0_SPEC> {
        HEN17_W::new(self, 17)
    }
    #[doc = "Bit 18 - High detect enabled 18"]
    #[inline(always)]
    #[must_use]
    pub fn hen18(&mut self) -> HEN18_W<GPHEN0_SPEC> {
        HEN18_W::new(self, 18)
    }
    #[doc = "Bit 19 - High detect enabled 19"]
    #[inline(always)]
    #[must_use]
    pub fn hen19(&mut self) -> HEN19_W<GPHEN0_SPEC> {
        HEN19_W::new(self, 19)
    }
    #[doc = "Bit 20 - High detect enabled 20"]
    #[inline(always)]
    #[must_use]
    pub fn hen20(&mut self) -> HEN20_W<GPHEN0_SPEC> {
        HEN20_W::new(self, 20)
    }
    #[doc = "Bit 21 - High detect enabled 21"]
    #[inline(always)]
    #[must_use]
    pub fn hen21(&mut self) -> HEN21_W<GPHEN0_SPEC> {
        HEN21_W::new(self, 21)
    }
    #[doc = "Bit 22 - High detect enabled 22"]
    #[inline(always)]
    #[must_use]
    pub fn hen22(&mut self) -> HEN22_W<GPHEN0_SPEC> {
        HEN22_W::new(self, 22)
    }
    #[doc = "Bit 23 - High detect enabled 23"]
    #[inline(always)]
    #[must_use]
    pub fn hen23(&mut self) -> HEN23_W<GPHEN0_SPEC> {
        HEN23_W::new(self, 23)
    }
    #[doc = "Bit 24 - High detect enabled 24"]
    #[inline(always)]
    #[must_use]
    pub fn hen24(&mut self) -> HEN24_W<GPHEN0_SPEC> {
        HEN24_W::new(self, 24)
    }
    #[doc = "Bit 25 - High detect enabled 25"]
    #[inline(always)]
    #[must_use]
    pub fn hen25(&mut self) -> HEN25_W<GPHEN0_SPEC> {
        HEN25_W::new(self, 25)
    }
    #[doc = "Bit 26 - High detect enabled 26"]
    #[inline(always)]
    #[must_use]
    pub fn hen26(&mut self) -> HEN26_W<GPHEN0_SPEC> {
        HEN26_W::new(self, 26)
    }
    #[doc = "Bit 27 - High detect enabled 27"]
    #[inline(always)]
    #[must_use]
    pub fn hen27(&mut self) -> HEN27_W<GPHEN0_SPEC> {
        HEN27_W::new(self, 27)
    }
    #[doc = "Bit 28 - High detect enabled 28"]
    #[inline(always)]
    #[must_use]
    pub fn hen28(&mut self) -> HEN28_W<GPHEN0_SPEC> {
        HEN28_W::new(self, 28)
    }
    #[doc = "Bit 29 - High detect enabled 29"]
    #[inline(always)]
    #[must_use]
    pub fn hen29(&mut self) -> HEN29_W<GPHEN0_SPEC> {
        HEN29_W::new(self, 29)
    }
    #[doc = "Bit 30 - High detect enabled 30"]
    #[inline(always)]
    #[must_use]
    pub fn hen30(&mut self) -> HEN30_W<GPHEN0_SPEC> {
        HEN30_W::new(self, 30)
    }
    #[doc = "Bit 31 - High detect enabled 31"]
    #[inline(always)]
    #[must_use]
    pub fn hen31(&mut self) -> HEN31_W<GPHEN0_SPEC> {
        HEN31_W::new(self, 31)
    }
