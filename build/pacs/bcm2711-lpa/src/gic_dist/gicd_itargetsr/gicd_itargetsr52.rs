...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int208(&mut self) -> INT208_W<GICD_ITARGETSR52_SPEC> {
        INT208_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 209"]
    #[inline(always)]
    #[must_use]
    pub fn int209(&mut self) -> INT209_W<GICD_ITARGETSR52_SPEC> {
        INT209_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 210"]
    #[inline(always)]
    #[must_use]
    pub fn int210(&mut self) -> INT210_W<GICD_ITARGETSR52_SPEC> {
        INT210_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 211"]
    #[inline(always)]
    #[must_use]
    pub fn int211(&mut self) -> INT211_W<GICD_ITARGETSR52_SPEC> {
