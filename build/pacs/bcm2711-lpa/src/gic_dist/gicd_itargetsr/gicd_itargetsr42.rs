...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int168(&mut self) -> INT168_W<GICD_ITARGETSR42_SPEC> {
        INT168_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 169"]
    #[inline(always)]
    #[must_use]
    pub fn int169(&mut self) -> INT169_W<GICD_ITARGETSR42_SPEC> {
        INT169_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 170"]
    #[inline(always)]
    #[must_use]
    pub fn int170(&mut self) -> INT170_W<GICD_ITARGETSR42_SPEC> {
        INT170_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 171"]
    #[inline(always)]
    #[must_use]
    pub fn int171(&mut self) -> INT171_W<GICD_ITARGETSR42_SPEC> {
