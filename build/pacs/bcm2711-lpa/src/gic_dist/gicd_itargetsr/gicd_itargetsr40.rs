...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int160(&mut self) -> INT160_W<GICD_ITARGETSR40_SPEC> {
        INT160_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 161"]
    #[inline(always)]
    #[must_use]
    pub fn int161(&mut self) -> INT161_W<GICD_ITARGETSR40_SPEC> {
        INT161_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 162"]
    #[inline(always)]
    #[must_use]
    pub fn int162(&mut self) -> INT162_W<GICD_ITARGETSR40_SPEC> {
        INT162_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 163"]
    #[inline(always)]
    #[must_use]
    pub fn int163(&mut self) -> INT163_W<GICD_ITARGETSR40_SPEC> {
