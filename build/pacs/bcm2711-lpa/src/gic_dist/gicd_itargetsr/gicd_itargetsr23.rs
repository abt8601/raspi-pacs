...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int92(&mut self) -> INT92_W<GICD_ITARGETSR23_SPEC> {
        INT92_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 93"]
    #[inline(always)]
    #[must_use]
    pub fn int93(&mut self) -> INT93_W<GICD_ITARGETSR23_SPEC> {
        INT93_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 94"]
    #[inline(always)]
    #[must_use]
    pub fn int94(&mut self) -> INT94_W<GICD_ITARGETSR23_SPEC> {
        INT94_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 95"]
    #[inline(always)]
    #[must_use]
    pub fn int95(&mut self) -> INT95_W<GICD_ITARGETSR23_SPEC> {
        INT95_W::new(self, 24)
    }
