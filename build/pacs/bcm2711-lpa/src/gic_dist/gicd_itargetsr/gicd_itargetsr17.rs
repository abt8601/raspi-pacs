...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vpu0_halted(&mut self) -> VPU0_HALTED_W<GICD_ITARGETSR17_SPEC> {
        VPU0_HALTED_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - VPU1 halted"]
    #[inline(always)]
    #[must_use]
    pub fn vpu1_halted(&mut self) -> VPU1_HALTED_W<GICD_ITARGETSR17_SPEC> {
        VPU1_HALTED_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - ARM address error"]
    #[inline(always)]
    #[must_use]
    pub fn arm_address_error(&mut self) -> ARM_ADDRESS_ERROR_W<GICD_ITARGETSR17_SPEC> {
        ARM_ADDRESS_ERROR_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - ARM AXI error"]
    #[inline(always)]
    #[must_use]
    pub fn arm_axi_error(&mut self) -> ARM_AXI_ERROR_W<GICD_ITARGETSR17_SPEC> {
