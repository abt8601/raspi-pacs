...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int12(&mut self) -> INT12_W<GICD_IPRIORITYR3_SPEC> {
        INT12_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 13"]
    #[inline(always)]
    #[must_use]
    pub fn int13(&mut self) -> INT13_W<GICD_IPRIORITYR3_SPEC> {
        INT13_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 14"]
    #[inline(always)]
    #[must_use]
    pub fn int14(&mut self) -> INT14_W<GICD_IPRIORITYR3_SPEC> {
        INT14_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 15"]
    #[inline(always)]
    #[must_use]
    pub fn int15(&mut self) -> INT15_W<GICD_IPRIORITYR3_SPEC> {
        INT15_W::new(self, 24)
    }
