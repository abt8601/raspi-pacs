...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn isp(&mut self) -> ISP_W<GICD_IPRIORITYR26_SPEC> {
        ISP_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - USB"]
    #[inline(always)]
    #[must_use]
    pub fn usb(&mut self) -> USB_W<GICD_IPRIORITYR26_SPEC> {
        USB_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - V3D"]
    #[inline(always)]
    #[must_use]
    pub fn v3d(&mut self) -> V3D_W<GICD_IPRIORITYR26_SPEC> {
        V3D_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Transposer"]
    #[inline(always)]
    #[must_use]
    pub fn transposer(&mut self) -> TRANSPOSER_W<GICD_IPRIORITYR26_SPEC> {
