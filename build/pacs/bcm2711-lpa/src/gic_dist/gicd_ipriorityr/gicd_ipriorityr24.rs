...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer_0(&mut self) -> TIMER_0_W<GICD_IPRIORITYR24_SPEC> {
        TIMER_0_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Timer 1"]
    #[inline(always)]
    #[must_use]
    pub fn timer_1(&mut self) -> TIMER_1_W<GICD_IPRIORITYR24_SPEC> {
        TIMER_1_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Timer 2"]
    #[inline(always)]
    #[must_use]
    pub fn timer_2(&mut self) -> TIMER_2_W<GICD_IPRIORITYR24_SPEC> {
        TIMER_2_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Timer 3"]
    #[inline(always)]
    #[must_use]
    pub fn timer_3(&mut self) -> TIMER_3_W<GICD_IPRIORITYR24_SPEC> {
