...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int220(&mut self) -> INT220_W<GICD_IPRIORITYR55_SPEC> {
        INT220_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 221"]
    #[inline(always)]
    #[must_use]
    pub fn int221(&mut self) -> INT221_W<GICD_IPRIORITYR55_SPEC> {
        INT221_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 222"]
    #[inline(always)]
    #[must_use]
    pub fn int222(&mut self) -> INT222_W<GICD_IPRIORITYR55_SPEC> {
        INT222_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 223"]
    #[inline(always)]
    #[must_use]
    pub fn int223(&mut self) -> INT223_W<GICD_IPRIORITYR55_SPEC> {
