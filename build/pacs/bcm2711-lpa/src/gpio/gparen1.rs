...
pub type AREN54_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type AREN55_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type AREN56_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type AREN57_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aren54(&mut self) -> AREN54_W<GPAREN1_SPEC> {
        AREN54_W::new(self, 22)
    }
    #[doc = "Bit 23 - Async rising enabled 55"]
    #[inline(always)]
    #[must_use]
    pub fn aren55(&mut self) -> AREN55_W<GPAREN1_SPEC> {
        AREN55_W::new(self, 23)
    }
    #[doc = "Bit 24 - Async rising enabled 56"]
    #[inline(always)]
    #[must_use]
    pub fn aren56(&mut self) -> AREN56_W<GPAREN1_SPEC> {
        AREN56_W::new(self, 24)
    }
    #[doc = "Bit 25 - Async rising enabled 57"]
    #[inline(always)]
    #[must_use]
    pub fn aren57(&mut self) -> AREN57_W<GPAREN1_SPEC> {
        AREN57_W::new(self, 25)
    }
