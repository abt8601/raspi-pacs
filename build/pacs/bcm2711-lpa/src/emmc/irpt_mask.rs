...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmd_done(&mut self) -> CMD_DONE_W<IRPT_MASK_SPEC> {
        CMD_DONE_W::new(self, 0)
    }
    #[doc = "Bit 1 - Data transfer has finished"]
    #[inline(always)]
    #[must_use]
    pub fn data_done(&mut self) -> DATA_DONE_W<IRPT_MASK_SPEC> {
        DATA_DONE_W::new(self, 1)
    }
    #[doc = "Bit 2 - Data transfer has stopped at block gap"]
    #[inline(always)]
    #[must_use]
    pub fn block_gap(&mut self) -> BLOCK_GAP_W<IRPT_MASK_SPEC> {
        BLOCK_GAP_W::new(self, 2)
    }
    #[doc = "Bit 4 - DATA can be written to"]
    #[inline(always)]
    #[must_use]
    pub fn write_rdy(&mut self) -> WRITE_RDY_W<IRPT_MASK_SPEC> {
        WRITE_RDY_W::new(self, 4)
    }
    #[doc = "Bit 5 - DATA contains data to be read"]
    #[inline(always)]
    #[must_use]
    pub fn read_rdy(&mut self) -> READ_RDY_W<IRPT_MASK_SPEC> {
        READ_RDY_W::new(self, 5)
    }
    #[doc = "Bit 8 - Card made interrupt request"]
    #[inline(always)]
    #[must_use]
    pub fn card(&mut self) -> CARD_W<IRPT_MASK_SPEC> {
        CARD_W::new(self, 8)
    }
    #[doc = "Bit 12 - Clock retune request"]
    #[inline(always)]
    #[must_use]
    pub fn retune(&mut self) -> RETUNE_W<IRPT_MASK_SPEC> {
        RETUNE_W::new(self, 12)
    }
    #[doc = "Bit 13 - Boot has been acknowledged"]
    #[inline(always)]
    #[must_use]
    pub fn bootack(&mut self) -> BOOTACK_W<IRPT_MASK_SPEC> {
        BOOTACK_W::new(self, 13)
    }
    #[doc = "Bit 14 - Boot operation has terminated"]
    #[inline(always)]
    #[must_use]
    pub fn endboot(&mut self) -> ENDBOOT_W<IRPT_MASK_SPEC> {
        ENDBOOT_W::new(self, 14)
    }
    #[doc = "Bit 16 - Command timeout"]
    #[inline(always)]
    #[must_use]
    pub fn cto_err(&mut self) -> CTO_ERR_W<IRPT_MASK_SPEC> {
        CTO_ERR_W::new(self, 16)
    }
    #[doc = "Bit 17 - Command CRC error"]
    #[inline(always)]
    #[must_use]
    pub fn ccrc_err(&mut self) -> CCRC_ERR_W<IRPT_MASK_SPEC> {
        CCRC_ERR_W::new(self, 17)
    }
    #[doc = "Bit 18 - Command end bit error (not 1)"]
    #[inline(always)]
    #[must_use]
    pub fn cend_err(&mut self) -> CEND_ERR_W<IRPT_MASK_SPEC> {
        CEND_ERR_W::new(self, 18)
    }
    #[doc = "Bit 19 - Incorrect response command index"]
    #[inline(always)]
    #[must_use]
    pub fn cbad_err(&mut self) -> CBAD_ERR_W<IRPT_MASK_SPEC> {
        CBAD_ERR_W::new(self, 19)
    }
    #[doc = "Bit 20 - Data timeout"]
    #[inline(always)]
    #[must_use]
    pub fn dto_err(&mut self) -> DTO_ERR_W<IRPT_MASK_SPEC> {
        DTO_ERR_W::new(self, 20)
    }
    #[doc = "Bit 21 - Data CRC error"]
    #[inline(always)]
    #[must_use]
    pub fn dcrc_err(&mut self) -> DCRC_ERR_W<IRPT_MASK_SPEC> {
        DCRC_ERR_W::new(self, 21)
    }
    #[doc = "Bit 22 - Data end bit error (not 1)"]
    #[inline(always)]
    #[must_use]
    pub fn dend_err(&mut self) -> DEND_ERR_W<IRPT_MASK_SPEC> {
        DEND_ERR_W::new(self, 22)
    }
    #[doc = "Bit 24 - Auto command error"]
    #[inline(always)]
    #[must_use]
    pub fn acmd_err(&mut self) -> ACMD_ERR_W<IRPT_MASK_SPEC> {
