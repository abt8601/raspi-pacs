...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int0(&mut self) -> INT0_W<GICD_IPRIORITYR0_SPEC> {
        INT0_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 1"]
    #[inline(always)]
    #[must_use]
    pub fn int1(&mut self) -> INT1_W<GICD_IPRIORITYR0_SPEC> {
        INT1_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 2"]
    #[inline(always)]
    #[must_use]
    pub fn int2(&mut self) -> INT2_W<GICD_IPRIORITYR0_SPEC> {
        INT2_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 3"]
    #[inline(always)]
    #[must_use]
    pub fn int3(&mut self) -> INT3_W<GICD_IPRIORITYR0_SPEC> {
        INT3_W::new(self, 24)
    }
