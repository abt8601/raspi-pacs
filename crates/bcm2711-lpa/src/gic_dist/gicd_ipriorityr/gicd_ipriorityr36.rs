...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn smi(&mut self) -> SMI_W<GICD_IPRIORITYR36_SPEC, 0> {
        SMI_W::new(self)
    }
    #[doc = "Bits 8:15 - GPIO 0"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_0(&mut self) -> GPIO_0_W<GICD_IPRIORITYR36_SPEC, 8> {
        GPIO_0_W::new(self)
    }
    #[doc = "Bits 16:23 - GPIO 1"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_1(&mut self) -> GPIO_1_W<GICD_IPRIORITYR36_SPEC, 16> {
        GPIO_1_W::new(self)
    }
    #[doc = "Bits 24:31 - GPIO 2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_2(&mut self) -> GPIO_2_W<GICD_IPRIORITYR36_SPEC, 24> {
        GPIO_2_W::new(self)
    }
