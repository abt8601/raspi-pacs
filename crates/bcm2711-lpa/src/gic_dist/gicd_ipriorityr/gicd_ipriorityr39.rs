...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpg(&mut self) -> CPG_W<GICD_IPRIORITYR39_SPEC> {
        CPG_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - RNG"]
    #[inline(always)]
    #[must_use]
    pub fn rng(&mut self) -> RNG_W<GICD_IPRIORITYR39_SPEC> {
        RNG_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - OR of EMMC and EMMC2"]
    #[inline(always)]
    #[must_use]
    pub fn emmc(&mut self) -> EMMC_W<GICD_IPRIORITYR39_SPEC> {
        EMMC_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - ETH_PCIe secure"]
    #[inline(always)]
    #[must_use]
    pub fn eth_pcie_secure(&mut self) -> ETH_PCIE_SECURE_W<GICD_IPRIORITYR39_SPEC> {
