...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swi0(&mut self) -> SWI0_W<GICD_IPRIORITYR18_SPEC, 0> {
        SWI0_W::new(self)
    }
    #[doc = "Bits 8:15 - Software interrupt 1"]
    #[inline(always)]
    #[must_use]
    pub fn swi1(&mut self) -> SWI1_W<GICD_IPRIORITYR18_SPEC, 8> {
        SWI1_W::new(self)
    }
    #[doc = "Bits 16:23 - Software interrupt 2"]
    #[inline(always)]
    #[must_use]
    pub fn swi2(&mut self) -> SWI2_W<GICD_IPRIORITYR18_SPEC, 16> {
        SWI2_W::new(self)
    }
    #[doc = "Bits 24:31 - Software interrupt 3"]
    #[inline(always)]
    #[must_use]
    pub fn swi3(&mut self) -> SWI3_W<GICD_IPRIORITYR18_SPEC, 24> {
        SWI3_W::new(self)
    }
