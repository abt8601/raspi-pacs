...
pub type DMA_14_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_IPRIORITYR31_SPEC, u8, u8, 8, O>;
...
pub type AUX_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GICD_IPRIORITYR31_SPEC, u8, u8, 8, O>;
#[doc = "Field `ARM` reader - ARM"]
pub type ARM_R = crate::FieldReader<u8, u8>;
#[doc = "Field `ARM` writer - ARM"]
pub type ARM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GICD_IPRIORITYR31_SPEC, u8, u8, 8, O>;
