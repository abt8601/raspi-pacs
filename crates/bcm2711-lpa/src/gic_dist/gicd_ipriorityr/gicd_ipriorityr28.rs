...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_0(&mut self) -> DMA_0_W<GICD_IPRIORITYR28_SPEC, 0> {
        DMA_0_W::new(self)
    }
    #[doc = "Bits 8:15 - DMA 1"]
    #[inline(always)]
    #[must_use]
    pub fn dma_1(&mut self) -> DMA_1_W<GICD_IPRIORITYR28_SPEC, 8> {
        DMA_1_W::new(self)
    }
    #[doc = "Bits 16:23 - DMA 2"]
    #[inline(always)]
    #[must_use]
    pub fn dma_2(&mut self) -> DMA_2_W<GICD_IPRIORITYR28_SPEC, 16> {
        DMA_2_W::new(self)
    }
    #[doc = "Bits 24:31 - DMA 3"]
    #[inline(always)]
    #[must_use]
    pub fn dma_3(&mut self) -> DMA_3_W<GICD_IPRIORITYR28_SPEC, 24> {
        DMA_3_W::new(self)
    }
