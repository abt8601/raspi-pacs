...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int32(&mut self) -> INT32_W<GICD_IPRIORITYR8_SPEC, 0> {
        INT32_W::new(self)
    }
    #[doc = "Bits 8:15 - Interrupt 33"]
    #[inline(always)]
    #[must_use]
    pub fn int33(&mut self) -> INT33_W<GICD_IPRIORITYR8_SPEC, 8> {
        INT33_W::new(self)
    }
    #[doc = "Bits 16:23 - Interrupt 34"]
    #[inline(always)]
    #[must_use]
    pub fn int34(&mut self) -> INT34_W<GICD_IPRIORITYR8_SPEC, 16> {
        INT34_W::new(self)
    }
    #[doc = "Bits 24:31 - Interrupt 35"]
    #[inline(always)]
    #[must_use]
    pub fn int35(&mut self) -> INT35_W<GICD_IPRIORITYR8_SPEC, 24> {
        INT35_W::new(self)
    }
