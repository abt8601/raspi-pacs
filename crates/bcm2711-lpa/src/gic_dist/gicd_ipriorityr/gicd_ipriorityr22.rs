...
pub type INT88_R = crate::FieldReader<u8, u8>;
#[doc = "Field `INT88` writer - Interrupt 88"]
pub type INT88_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_IPRIORITYR22_SPEC, u8, u8, 8, O>;
#[doc = "Field `INT89` reader - Interrupt 89"]
pub type INT89_R = crate::FieldReader<u8, u8>;
#[doc = "Field `INT89` writer - Interrupt 89"]
pub type INT89_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_IPRIORITYR22_SPEC, u8, u8, 8, O>;
#[doc = "Field `INT90` reader - Interrupt 90"]
pub type INT90_R = crate::FieldReader<u8, u8>;
#[doc = "Field `INT90` writer - Interrupt 90"]
pub type INT90_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_IPRIORITYR22_SPEC, u8, u8, 8, O>;
#[doc = "Field `INT91` reader - Interrupt 91"]
pub type INT91_R = crate::FieldReader<u8, u8>;
#[doc = "Field `INT91` writer - Interrupt 91"]
pub type INT91_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_IPRIORITYR22_SPEC, u8, u8, 8, O>;
impl R {
