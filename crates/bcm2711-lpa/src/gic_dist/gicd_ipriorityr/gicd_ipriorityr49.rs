...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int196(&mut self) -> INT196_W<GICD_IPRIORITYR49_SPEC, 0> {
        INT196_W::new(self)
    }
    #[doc = "Bits 8:15 - Interrupt 197"]
    #[inline(always)]
    #[must_use]
    pub fn int197(&mut self) -> INT197_W<GICD_IPRIORITYR49_SPEC, 8> {
        INT197_W::new(self)
    }
    #[doc = "Bits 16:23 - Interrupt 198"]
    #[inline(always)]
    #[must_use]
    pub fn int198(&mut self) -> INT198_W<GICD_IPRIORITYR49_SPEC, 16> {
        INT198_W::new(self)
    }
    #[doc = "Bits 24:31 - Interrupt 199"]
    #[inline(always)]
    #[must_use]
    pub fn int199(&mut self) -> INT199_W<GICD_IPRIORITYR49_SPEC, 24> {
        INT199_W::new(self)
    }
