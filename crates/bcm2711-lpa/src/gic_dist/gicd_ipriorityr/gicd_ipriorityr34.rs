...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hdmi_0(&mut self) -> HDMI_0_W<GICD_IPRIORITYR34_SPEC> {
        HDMI_0_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - HDMI 1"]
    #[inline(always)]
    #[must_use]
    pub fn hdmi_1(&mut self) -> HDMI_1_W<GICD_IPRIORITYR34_SPEC> {
        HDMI_1_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Pixel Valve 3"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_3(&mut self) -> PIXEL_VALVE_3_W<GICD_IPRIORITYR34_SPEC> {
        PIXEL_VALVE_3_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - SPI/BSC Slave"]
    #[inline(always)]
    #[must_use]
    pub fn spi_bsc_slave(&mut self) -> SPI_BSC_SLAVE_W<GICD_IPRIORITYR34_SPEC> {
