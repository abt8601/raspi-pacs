...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int56(&mut self) -> INT56_W<GICD_IPRIORITYR14_SPEC> {
        INT56_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 57"]
    #[inline(always)]
    #[must_use]
    pub fn int57(&mut self) -> INT57_W<GICD_IPRIORITYR14_SPEC> {
        INT57_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 58"]
    #[inline(always)]
    #[must_use]
    pub fn int58(&mut self) -> INT58_W<GICD_IPRIORITYR14_SPEC> {
        INT58_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 59"]
    #[inline(always)]
    #[must_use]
    pub fn int59(&mut self) -> INT59_W<GICD_IPRIORITYR14_SPEC> {
        INT59_W::new(self, 24)
    }
