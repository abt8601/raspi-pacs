...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int188(&mut self) -> INT188_W<GICD_IPRIORITYR47_SPEC, 0> {
        INT188_W::new(self)
    }
    #[doc = "Bits 8:15 - Interrupt 189"]
    #[inline(always)]
    #[must_use]
    pub fn int189(&mut self) -> INT189_W<GICD_IPRIORITYR47_SPEC, 8> {
        INT189_W::new(self)
    }
    #[doc = "Bits 16:23 - Interrupt 190"]
    #[inline(always)]
    #[must_use]
    pub fn int190(&mut self) -> INT190_W<GICD_IPRIORITYR47_SPEC, 16> {
        INT190_W::new(self)
    }
    #[doc = "Bits 24:31 - Interrupt 191"]
    #[inline(always)]
    #[must_use]
    pub fn int191(&mut self) -> INT191_W<GICD_IPRIORITYR47_SPEC, 24> {
        INT191_W::new(self)
    }
