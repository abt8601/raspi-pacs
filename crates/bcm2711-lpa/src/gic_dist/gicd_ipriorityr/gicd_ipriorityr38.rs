...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdhost(&mut self) -> SDHOST_W<GICD_IPRIORITYR38_SPEC, 0> {
        SDHOST_W::new(self)
    }
    #[doc = "Bits 8:15 - OR of all PL011 UARTs"]
    #[inline(always)]
    #[must_use]
    pub fn uart(&mut self) -> UART_W<GICD_IPRIORITYR38_SPEC, 8> {
        UART_W::new(self)
    }
    #[doc = "Bits 16:23 - OR of all ETH_PCIe L2"]
    #[inline(always)]
    #[must_use]
    pub fn eth_pcie(&mut self) -> ETH_PCIE_W<GICD_IPRIORITYR38_SPEC, 16> {
        ETH_PCIE_W::new(self)
    }
    #[doc = "Bits 24:31 - VEC"]
    #[inline(always)]
    #[must_use]
    pub fn vec(&mut self) -> VEC_W<GICD_IPRIORITYR38_SPEC, 24> {
        VEC_W::new(self)
    }
