...
pub type SDHOST_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_IPRIORITYR38_SPEC, u8, u8, 8, O>;
...
pub type VEC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GICD_IPRIORITYR38_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - SDHOST"]
    #[inline(always)]
