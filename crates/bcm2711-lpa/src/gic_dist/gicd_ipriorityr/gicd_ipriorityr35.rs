...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dsi_1(&mut self) -> DSI_1_W<GICD_IPRIORITYR35_SPEC, 0> {
        DSI_1_W::new(self)
    }
    #[doc = "Bits 8:15 - Pixel Valve 0"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_0(&mut self) -> PIXEL_VALVE_0_W<GICD_IPRIORITYR35_SPEC, 8> {
        PIXEL_VALVE_0_W::new(self)
    }
    #[doc = "Bits 16:23 - OR of Pixel Valve 1 and 2"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_1_2(&mut self) -> PIXEL_VALVE_1_2_W<GICD_IPRIORITYR35_SPEC, 16> {
        PIXEL_VALVE_1_2_W::new(self)
    }
    #[doc = "Bits 24:31 - CPR"]
    #[inline(always)]
    #[must_use]
    pub fn cpr(&mut self) -> CPR_W<GICD_IPRIORITYR35_SPEC, 24> {
        CPR_W::new(self)
    }
