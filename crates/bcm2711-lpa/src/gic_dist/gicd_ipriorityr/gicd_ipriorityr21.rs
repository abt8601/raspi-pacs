...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int84(&mut self) -> INT84_W<GICD_IPRIORITYR21_SPEC> {
        INT84_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 85"]
    #[inline(always)]
    #[must_use]
    pub fn int85(&mut self) -> INT85_W<GICD_IPRIORITYR21_SPEC> {
        INT85_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 86"]
    #[inline(always)]
    #[must_use]
    pub fn int86(&mut self) -> INT86_W<GICD_IPRIORITYR21_SPEC> {
        INT86_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 87"]
    #[inline(always)]
    #[must_use]
    pub fn int87(&mut self) -> INT87_W<GICD_IPRIORITYR21_SPEC> {
        INT87_W::new(self, 24)
    }
