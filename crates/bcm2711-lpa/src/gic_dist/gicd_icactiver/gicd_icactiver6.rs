...
pub type R = crate::R<GICD_ICACTIVER6_SPEC>;
#[doc = "Register `GICD_ICACTIVER6` writer"]
pub type W = crate::W<GICD_ICACTIVER6_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int192(&mut self) -> INT192_W<GICD_ICACTIVER6_SPEC, 0> {
        INT192_W::new(self)
    }
    #[doc = "Bit 1 - Interrupt 193"]
    #[inline(always)]
    #[must_use]
    pub fn int193(&mut self) -> INT193_W<GICD_ICACTIVER6_SPEC, 1> {
        INT193_W::new(self)
    }
    #[doc = "Bit 2 - Interrupt 194"]
    #[inline(always)]
    #[must_use]
    pub fn int194(&mut self) -> INT194_W<GICD_ICACTIVER6_SPEC, 2> {
        INT194_W::new(self)
    }
    #[doc = "Bit 3 - Interrupt 195"]
    #[inline(always)]
    #[must_use]
    pub fn int195(&mut self) -> INT195_W<GICD_ICACTIVER6_SPEC, 3> {
        INT195_W::new(self)
    }
    #[doc = "Bit 4 - Interrupt 196"]
    #[inline(always)]
    #[must_use]
    pub fn int196(&mut self) -> INT196_W<GICD_ICACTIVER6_SPEC, 4> {
        INT196_W::new(self)
    }
    #[doc = "Bit 5 - Interrupt 197"]
    #[inline(always)]
    #[must_use]
    pub fn int197(&mut self) -> INT197_W<GICD_ICACTIVER6_SPEC, 5> {
        INT197_W::new(self)
    }
    #[doc = "Bit 6 - Interrupt 198"]
    #[inline(always)]
    #[must_use]
    pub fn int198(&mut self) -> INT198_W<GICD_ICACTIVER6_SPEC, 6> {
        INT198_W::new(self)
    }
    #[doc = "Bit 7 - Interrupt 199"]
    #[inline(always)]
    #[must_use]
    pub fn int199(&mut self) -> INT199_W<GICD_ICACTIVER6_SPEC, 7> {
        INT199_W::new(self)
    }
    #[doc = "Bit 8 - Interrupt 200"]
    #[inline(always)]
    #[must_use]
    pub fn int200(&mut self) -> INT200_W<GICD_ICACTIVER6_SPEC, 8> {
        INT200_W::new(self)
    }
    #[doc = "Bit 9 - Interrupt 201"]
    #[inline(always)]
    #[must_use]
    pub fn int201(&mut self) -> INT201_W<GICD_ICACTIVER6_SPEC, 9> {
        INT201_W::new(self)
    }
    #[doc = "Bit 10 - Interrupt 202"]
    #[inline(always)]
    #[must_use]
    pub fn int202(&mut self) -> INT202_W<GICD_ICACTIVER6_SPEC, 10> {
        INT202_W::new(self)
    }
    #[doc = "Bit 11 - Interrupt 203"]
    #[inline(always)]
    #[must_use]
    pub fn int203(&mut self) -> INT203_W<GICD_ICACTIVER6_SPEC, 11> {
        INT203_W::new(self)
    }
    #[doc = "Bit 12 - Interrupt 204"]
    #[inline(always)]
    #[must_use]
    pub fn int204(&mut self) -> INT204_W<GICD_ICACTIVER6_SPEC, 12> {
        INT204_W::new(self)
    }
    #[doc = "Bit 13 - Interrupt 205"]
    #[inline(always)]
    #[must_use]
    pub fn int205(&mut self) -> INT205_W<GICD_ICACTIVER6_SPEC, 13> {
        INT205_W::new(self)
    }
    #[doc = "Bit 14 - Interrupt 206"]
    #[inline(always)]
    #[must_use]
    pub fn int206(&mut self) -> INT206_W<GICD_ICACTIVER6_SPEC, 14> {
        INT206_W::new(self)
    }
    #[doc = "Bit 15 - Interrupt 207"]
    #[inline(always)]
    #[must_use]
    pub fn int207(&mut self) -> INT207_W<GICD_ICACTIVER6_SPEC, 15> {
        INT207_W::new(self)
    }
    #[doc = "Bit 16 - Interrupt 208"]
    #[inline(always)]
    #[must_use]
    pub fn int208(&mut self) -> INT208_W<GICD_ICACTIVER6_SPEC, 16> {
        INT208_W::new(self)
    }
    #[doc = "Bit 17 - Interrupt 209"]
    #[inline(always)]
    #[must_use]
    pub fn int209(&mut self) -> INT209_W<GICD_ICACTIVER6_SPEC, 17> {
        INT209_W::new(self)
    }
    #[doc = "Bit 18 - Interrupt 210"]
    #[inline(always)]
    #[must_use]
    pub fn int210(&mut self) -> INT210_W<GICD_ICACTIVER6_SPEC, 18> {
        INT210_W::new(self)
    }
    #[doc = "Bit 19 - Interrupt 211"]
    #[inline(always)]
    #[must_use]
    pub fn int211(&mut self) -> INT211_W<GICD_ICACTIVER6_SPEC, 19> {
        INT211_W::new(self)
    }
    #[doc = "Bit 20 - Interrupt 212"]
    #[inline(always)]
    #[must_use]
    pub fn int212(&mut self) -> INT212_W<GICD_ICACTIVER6_SPEC, 20> {
        INT212_W::new(self)
    }
    #[doc = "Bit 21 - Interrupt 213"]
    #[inline(always)]
    #[must_use]
    pub fn int213(&mut self) -> INT213_W<GICD_ICACTIVER6_SPEC, 21> {
        INT213_W::new(self)
    }
    #[doc = "Bit 22 - Interrupt 214"]
    #[inline(always)]
    #[must_use]
    pub fn int214(&mut self) -> INT214_W<GICD_ICACTIVER6_SPEC, 22> {
        INT214_W::new(self)
    }
    #[doc = "Bit 23 - Interrupt 215"]
    #[inline(always)]
    #[must_use]
    pub fn int215(&mut self) -> INT215_W<GICD_ICACTIVER6_SPEC, 23> {
        INT215_W::new(self)
    }
    #[doc = "Bit 24 - Interrupt 216"]
    #[inline(always)]
    #[must_use]
    pub fn int216(&mut self) -> INT216_W<GICD_ICACTIVER6_SPEC, 24> {
        INT216_W::new(self)
    }
    #[doc = "Bit 25 - Interrupt 217"]
    #[inline(always)]
    #[must_use]
    pub fn int217(&mut self) -> INT217_W<GICD_ICACTIVER6_SPEC, 25> {
        INT217_W::new(self)
    }
    #[doc = "Bit 26 - Interrupt 218"]
    #[inline(always)]
    #[must_use]
    pub fn int218(&mut self) -> INT218_W<GICD_ICACTIVER6_SPEC, 26> {
        INT218_W::new(self)
    }
    #[doc = "Bit 27 - Interrupt 219"]
    #[inline(always)]
    #[must_use]
    pub fn int219(&mut self) -> INT219_W<GICD_ICACTIVER6_SPEC, 27> {
        INT219_W::new(self)
    }
    #[doc = "Bit 28 - Interrupt 220"]
    #[inline(always)]
    #[must_use]
    pub fn int220(&mut self) -> INT220_W<GICD_ICACTIVER6_SPEC, 28> {
        INT220_W::new(self)
    }
    #[doc = "Bit 29 - Interrupt 221"]
    #[inline(always)]
    #[must_use]
    pub fn int221(&mut self) -> INT221_W<GICD_ICACTIVER6_SPEC, 29> {
        INT221_W::new(self)
    }
    #[doc = "Bit 30 - Interrupt 222"]
    #[inline(always)]
    #[must_use]
    pub fn int222(&mut self) -> INT222_W<GICD_ICACTIVER6_SPEC, 30> {
        INT222_W::new(self)
    }
    #[doc = "Bit 31 - Interrupt 223"]
    #[inline(always)]
    #[must_use]
    pub fn int223(&mut self) -> INT223_W<GICD_ICACTIVER6_SPEC, 31> {
        INT223_W::new(self)
    }
