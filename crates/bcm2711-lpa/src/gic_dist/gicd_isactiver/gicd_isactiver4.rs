...
pub type R = crate::R<GICD_ISACTIVER4_SPEC>;
#[doc = "Register `GICD_ISACTIVER4` writer"]
pub type W = crate::W<GICD_ISACTIVER4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hdmi_cec(&mut self) -> HDMI_CEC_W<GICD_ISACTIVER4_SPEC, 0> {
        HDMI_CEC_W::new(self)
    }
    #[doc = "Bit 1 - HVS"]
    #[inline(always)]
    #[must_use]
    pub fn hvs(&mut self) -> HVS_W<GICD_ISACTIVER4_SPEC, 1> {
        HVS_W::new(self)
    }
    #[doc = "Bit 2 - RPIVID"]
    #[inline(always)]
    #[must_use]
    pub fn rpivid(&mut self) -> RPIVID_W<GICD_ISACTIVER4_SPEC, 2> {
        RPIVID_W::new(self)
    }
    #[doc = "Bit 3 - SDC"]
    #[inline(always)]
    #[must_use]
    pub fn sdc(&mut self) -> SDC_W<GICD_ISACTIVER4_SPEC, 3> {
        SDC_W::new(self)
    }
    #[doc = "Bit 4 - DSI 0"]
    #[inline(always)]
    #[must_use]
    pub fn dsi_0(&mut self) -> DSI_0_W<GICD_ISACTIVER4_SPEC, 4> {
        DSI_0_W::new(self)
    }
    #[doc = "Bit 5 - Pixel Valve 2"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_2(&mut self) -> PIXEL_VALVE_2_W<GICD_ISACTIVER4_SPEC, 5> {
        PIXEL_VALVE_2_W::new(self)
    }
    #[doc = "Bit 6 - Camera 0"]
    #[inline(always)]
    #[must_use]
    pub fn camera_0(&mut self) -> CAMERA_0_W<GICD_ISACTIVER4_SPEC, 6> {
        CAMERA_0_W::new(self)
    }
    #[doc = "Bit 7 - Camera 1"]
    #[inline(always)]
    #[must_use]
    pub fn camera_1(&mut self) -> CAMERA_1_W<GICD_ISACTIVER4_SPEC, 7> {
        CAMERA_1_W::new(self)
    }
    #[doc = "Bit 8 - HDMI 0"]
    #[inline(always)]
    #[must_use]
    pub fn hdmi_0(&mut self) -> HDMI_0_W<GICD_ISACTIVER4_SPEC, 8> {
        HDMI_0_W::new(self)
    }
    #[doc = "Bit 9 - HDMI 1"]
    #[inline(always)]
    #[must_use]
    pub fn hdmi_1(&mut self) -> HDMI_1_W<GICD_ISACTIVER4_SPEC, 9> {
        HDMI_1_W::new(self)
    }
    #[doc = "Bit 10 - Pixel Valve 3"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_3(&mut self) -> PIXEL_VALVE_3_W<GICD_ISACTIVER4_SPEC, 10> {
        PIXEL_VALVE_3_W::new(self)
    }
    #[doc = "Bit 11 - SPI/BSC Slave"]
    #[inline(always)]
    #[must_use]
    pub fn spi_bsc_slave(&mut self) -> SPI_BSC_SLAVE_W<GICD_ISACTIVER4_SPEC, 11> {
        SPI_BSC_SLAVE_W::new(self)
    }
    #[doc = "Bit 12 - DSI 1"]
    #[inline(always)]
    #[must_use]
    pub fn dsi_1(&mut self) -> DSI_1_W<GICD_ISACTIVER4_SPEC, 12> {
        DSI_1_W::new(self)
    }
    #[doc = "Bit 13 - Pixel Valve 0"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_0(&mut self) -> PIXEL_VALVE_0_W<GICD_ISACTIVER4_SPEC, 13> {
        PIXEL_VALVE_0_W::new(self)
    }
    #[doc = "Bit 14 - OR of Pixel Valve 1 and 2"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_1_2(&mut self) -> PIXEL_VALVE_1_2_W<GICD_ISACTIVER4_SPEC, 14> {
        PIXEL_VALVE_1_2_W::new(self)
    }
    #[doc = "Bit 15 - CPR"]
    #[inline(always)]
    #[must_use]
    pub fn cpr(&mut self) -> CPR_W<GICD_ISACTIVER4_SPEC, 15> {
        CPR_W::new(self)
    }
    #[doc = "Bit 16 - SMI"]
    #[inline(always)]
    #[must_use]
    pub fn smi(&mut self) -> SMI_W<GICD_ISACTIVER4_SPEC, 16> {
        SMI_W::new(self)
    }
    #[doc = "Bit 17 - GPIO 0"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_0(&mut self) -> GPIO_0_W<GICD_ISACTIVER4_SPEC, 17> {
        GPIO_0_W::new(self)
    }
    #[doc = "Bit 18 - GPIO 1"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_1(&mut self) -> GPIO_1_W<GICD_ISACTIVER4_SPEC, 18> {
        GPIO_1_W::new(self)
    }
    #[doc = "Bit 19 - GPIO 2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_2(&mut self) -> GPIO_2_W<GICD_ISACTIVER4_SPEC, 19> {
        GPIO_2_W::new(self)
    }
    #[doc = "Bit 20 - GPIO 3"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_3(&mut self) -> GPIO_3_W<GICD_ISACTIVER4_SPEC, 20> {
        GPIO_3_W::new(self)
    }
    #[doc = "Bit 21 - OR of all I2C"]
    #[inline(always)]
    #[must_use]
    pub fn i2c(&mut self) -> I2C_W<GICD_ISACTIVER4_SPEC, 21> {
        I2C_W::new(self)
    }
    #[doc = "Bit 22 - OR of all SPI"]
    #[inline(always)]
    #[must_use]
    pub fn spi(&mut self) -> SPI_W<GICD_ISACTIVER4_SPEC, 22> {
        SPI_W::new(self)
    }
    #[doc = "Bit 23 - PCM/I2S"]
    #[inline(always)]
    #[must_use]
    pub fn pcm_i2s(&mut self) -> PCM_I2S_W<GICD_ISACTIVER4_SPEC, 23> {
        PCM_I2S_W::new(self)
    }
    #[doc = "Bit 24 - SDHOST"]
    #[inline(always)]
    #[must_use]
    pub fn sdhost(&mut self) -> SDHOST_W<GICD_ISACTIVER4_SPEC, 24> {
        SDHOST_W::new(self)
    }
    #[doc = "Bit 25 - OR of all PL011 UARTs"]
    #[inline(always)]
    #[must_use]
    pub fn uart(&mut self) -> UART_W<GICD_ISACTIVER4_SPEC, 25> {
        UART_W::new(self)
    }
    #[doc = "Bit 26 - OR of all ETH_PCIe L2"]
    #[inline(always)]
    #[must_use]
    pub fn eth_pcie(&mut self) -> ETH_PCIE_W<GICD_ISACTIVER4_SPEC, 26> {
        ETH_PCIE_W::new(self)
    }
    #[doc = "Bit 27 - VEC"]
    #[inline(always)]
    #[must_use]
    pub fn vec(&mut self) -> VEC_W<GICD_ISACTIVER4_SPEC, 27> {
        VEC_W::new(self)
    }
    #[doc = "Bit 28 - CPG"]
    #[inline(always)]
    #[must_use]
    pub fn cpg(&mut self) -> CPG_W<GICD_ISACTIVER4_SPEC, 28> {
        CPG_W::new(self)
    }
    #[doc = "Bit 29 - RNG"]
    #[inline(always)]
    #[must_use]
    pub fn rng(&mut self) -> RNG_W<GICD_ISACTIVER4_SPEC, 29> {
        RNG_W::new(self)
    }
    #[doc = "Bit 30 - OR of EMMC and EMMC2"]
    #[inline(always)]
    #[must_use]
    pub fn emmc(&mut self) -> EMMC_W<GICD_ISACTIVER4_SPEC, 30> {
        EMMC_W::new(self)
    }
    #[doc = "Bit 31 - ETH_PCIe secure"]
    #[inline(always)]
    #[must_use]
    pub fn eth_pcie_secure(&mut self) -> ETH_PCIE_SECURE_W<GICD_ISACTIVER4_SPEC, 31> {
