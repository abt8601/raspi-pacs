...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer_0(&mut self) -> TIMER_0_W<GICD_ISACTIVER3_SPEC, 0> {
        TIMER_0_W::new(self)
    }
    #[doc = "Bit 1 - Timer 1"]
    #[inline(always)]
    #[must_use]
    pub fn timer_1(&mut self) -> TIMER_1_W<GICD_ISACTIVER3_SPEC, 1> {
        TIMER_1_W::new(self)
    }
    #[doc = "Bit 2 - Timer 2"]
    #[inline(always)]
    #[must_use]
    pub fn timer_2(&mut self) -> TIMER_2_W<GICD_ISACTIVER3_SPEC, 2> {
        TIMER_2_W::new(self)
    }
    #[doc = "Bit 3 - Timer 3"]
    #[inline(always)]
    #[must_use]
    pub fn timer_3(&mut self) -> TIMER_3_W<GICD_ISACTIVER3_SPEC, 3> {
        TIMER_3_W::new(self)
    }
    #[doc = "Bit 4 - H264 0"]
    #[inline(always)]
    #[must_use]
    pub fn h264_0(&mut self) -> H264_0_W<GICD_ISACTIVER3_SPEC, 4> {
        H264_0_W::new(self)
    }
    #[doc = "Bit 5 - H264 1"]
    #[inline(always)]
    #[must_use]
    pub fn h264_1(&mut self) -> H264_1_W<GICD_ISACTIVER3_SPEC, 5> {
        H264_1_W::new(self)
    }
    #[doc = "Bit 6 - H264 2"]
    #[inline(always)]
    #[must_use]
    pub fn h264_2(&mut self) -> H264_2_W<GICD_ISACTIVER3_SPEC, 6> {
        H264_2_W::new(self)
    }
    #[doc = "Bit 7 - JPEG"]
    #[inline(always)]
    #[must_use]
    pub fn jpeg(&mut self) -> JPEG_W<GICD_ISACTIVER3_SPEC, 7> {
        JPEG_W::new(self)
    }
    #[doc = "Bit 8 - ISP"]
    #[inline(always)]
    #[must_use]
    pub fn isp(&mut self) -> ISP_W<GICD_ISACTIVER3_SPEC, 8> {
        ISP_W::new(self)
    }
    #[doc = "Bit 9 - USB"]
    #[inline(always)]
    #[must_use]
    pub fn usb(&mut self) -> USB_W<GICD_ISACTIVER3_SPEC, 9> {
        USB_W::new(self)
    }
    #[doc = "Bit 10 - V3D"]
    #[inline(always)]
    #[must_use]
    pub fn v3d(&mut self) -> V3D_W<GICD_ISACTIVER3_SPEC, 10> {
        V3D_W::new(self)
    }
    #[doc = "Bit 11 - Transposer"]
    #[inline(always)]
    #[must_use]
    pub fn transposer(&mut self) -> TRANSPOSER_W<GICD_ISACTIVER3_SPEC, 11> {
        TRANSPOSER_W::new(self)
    }
    #[doc = "Bit 12 - Multicore Sync 0"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_0(&mut self) -> MULTICORE_SYNC_0_W<GICD_ISACTIVER3_SPEC, 12> {
        MULTICORE_SYNC_0_W::new(self)
    }
    #[doc = "Bit 13 - Multicore Sync 1"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_1(&mut self) -> MULTICORE_SYNC_1_W<GICD_ISACTIVER3_SPEC, 13> {
        MULTICORE_SYNC_1_W::new(self)
    }
    #[doc = "Bit 14 - Multicore Sync 2"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_2(&mut self) -> MULTICORE_SYNC_2_W<GICD_ISACTIVER3_SPEC, 14> {
        MULTICORE_SYNC_2_W::new(self)
    }
    #[doc = "Bit 15 - Multicore Sync 3"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_3(&mut self) -> MULTICORE_SYNC_3_W<GICD_ISACTIVER3_SPEC, 15> {
        MULTICORE_SYNC_3_W::new(self)
    }
    #[doc = "Bit 16 - DMA 0"]
    #[inline(always)]
    #[must_use]
    pub fn dma_0(&mut self) -> DMA_0_W<GICD_ISACTIVER3_SPEC, 16> {
        DMA_0_W::new(self)
    }
    #[doc = "Bit 17 - DMA 1"]
    #[inline(always)]
    #[must_use]
    pub fn dma_1(&mut self) -> DMA_1_W<GICD_ISACTIVER3_SPEC, 17> {
        DMA_1_W::new(self)
    }
    #[doc = "Bit 18 - DMA 2"]
    #[inline(always)]
    #[must_use]
    pub fn dma_2(&mut self) -> DMA_2_W<GICD_ISACTIVER3_SPEC, 18> {
        DMA_2_W::new(self)
    }
    #[doc = "Bit 19 - DMA 3"]
    #[inline(always)]
    #[must_use]
    pub fn dma_3(&mut self) -> DMA_3_W<GICD_ISACTIVER3_SPEC, 19> {
        DMA_3_W::new(self)
    }
    #[doc = "Bit 20 - DMA 4"]
    #[inline(always)]
    #[must_use]
    pub fn dma_4(&mut self) -> DMA_4_W<GICD_ISACTIVER3_SPEC, 20> {
        DMA_4_W::new(self)
    }
    #[doc = "Bit 21 - DMA 5"]
    #[inline(always)]
    #[must_use]
    pub fn dma_5(&mut self) -> DMA_5_W<GICD_ISACTIVER3_SPEC, 21> {
        DMA_5_W::new(self)
    }
    #[doc = "Bit 22 - DMA 6"]
    #[inline(always)]
    #[must_use]
    pub fn dma_6(&mut self) -> DMA_6_W<GICD_ISACTIVER3_SPEC, 22> {
        DMA_6_W::new(self)
    }
    #[doc = "Bit 23 - OR of DMA 7 and 8"]
    #[inline(always)]
    #[must_use]
    pub fn dma_7_8(&mut self) -> DMA_7_8_W<GICD_ISACTIVER3_SPEC, 23> {
        DMA_7_8_W::new(self)
    }
    #[doc = "Bit 24 - OR of DMA 9 and 10"]
    #[inline(always)]
    #[must_use]
    pub fn dma_9_10(&mut self) -> DMA_9_10_W<GICD_ISACTIVER3_SPEC, 24> {
        DMA_9_10_W::new(self)
    }
    #[doc = "Bit 25 - DMA 11"]
    #[inline(always)]
    #[must_use]
    pub fn dma_11(&mut self) -> DMA_11_W<GICD_ISACTIVER3_SPEC, 25> {
        DMA_11_W::new(self)
    }
    #[doc = "Bit 26 - DMA 12"]
    #[inline(always)]
    #[must_use]
    pub fn dma_12(&mut self) -> DMA_12_W<GICD_ISACTIVER3_SPEC, 26> {
        DMA_12_W::new(self)
    }
    #[doc = "Bit 27 - DMA 13"]
    #[inline(always)]
    #[must_use]
    pub fn dma_13(&mut self) -> DMA_13_W<GICD_ISACTIVER3_SPEC, 27> {
        DMA_13_W::new(self)
    }
    #[doc = "Bit 28 - DMA 14"]
    #[inline(always)]
    #[must_use]
    pub fn dma_14(&mut self) -> DMA_14_W<GICD_ISACTIVER3_SPEC, 28> {
        DMA_14_W::new(self)
    }
    #[doc = "Bit 29 - OR of UART1, SPI1 and SPI2"]
    #[inline(always)]
    #[must_use]
    pub fn aux(&mut self) -> AUX_W<GICD_ISACTIVER3_SPEC, 29> {
        AUX_W::new(self)
    }
    #[doc = "Bit 30 - ARM"]
    #[inline(always)]
    #[must_use]
    pub fn arm(&mut self) -> ARM_W<GICD_ISACTIVER3_SPEC, 30> {
        ARM_W::new(self)
    }
    #[doc = "Bit 31 - DMA 15"]
    #[inline(always)]
    #[must_use]
    pub fn dma_15(&mut self) -> DMA_15_W<GICD_ISACTIVER3_SPEC, 31> {
        DMA_15_W::new(self)
    }
