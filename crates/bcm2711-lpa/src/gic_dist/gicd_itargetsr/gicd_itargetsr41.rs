...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int164(&mut self) -> INT164_W<GICD_ITARGETSR41_SPEC, 0> {
        INT164_W::new(self)
    }
    #[doc = "Bits 8:15 - Interrupt 165"]
    #[inline(always)]
    #[must_use]
    pub fn int165(&mut self) -> INT165_W<GICD_ITARGETSR41_SPEC, 8> {
        INT165_W::new(self)
    }
    #[doc = "Bits 16:23 - Interrupt 166"]
    #[inline(always)]
    #[must_use]
    pub fn int166(&mut self) -> INT166_W<GICD_ITARGETSR41_SPEC, 16> {
        INT166_W::new(self)
    }
    #[doc = "Bits 24:31 - Interrupt 167"]
    #[inline(always)]
    #[must_use]
    pub fn int167(&mut self) -> INT167_W<GICD_ITARGETSR41_SPEC, 24> {
        INT167_W::new(self)
    }
