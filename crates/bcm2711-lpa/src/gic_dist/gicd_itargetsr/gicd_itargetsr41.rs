...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int164(&mut self) -> INT164_W<GICD_ITARGETSR41_SPEC> {
        INT164_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 165"]
    #[inline(always)]
    #[must_use]
    pub fn int165(&mut self) -> INT165_W<GICD_ITARGETSR41_SPEC> {
        INT165_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 166"]
    #[inline(always)]
    #[must_use]
    pub fn int166(&mut self) -> INT166_W<GICD_ITARGETSR41_SPEC> {
        INT166_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 167"]
    #[inline(always)]
    #[must_use]
    pub fn int167(&mut self) -> INT167_W<GICD_ITARGETSR41_SPEC> {
        INT167_W::new(self, 24)
    }
