...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_0(&mut self) -> MULTICORE_SYNC_0_W<GICD_ITARGETSR27_SPEC, 0> {
        MULTICORE_SYNC_0_W::new(self)
    }
    #[doc = "Bits 8:15 - Multicore Sync 1"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_1(&mut self) -> MULTICORE_SYNC_1_W<GICD_ITARGETSR27_SPEC, 8> {
        MULTICORE_SYNC_1_W::new(self)
    }
    #[doc = "Bits 16:23 - Multicore Sync 2"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_2(&mut self) -> MULTICORE_SYNC_2_W<GICD_ITARGETSR27_SPEC, 16> {
        MULTICORE_SYNC_2_W::new(self)
    }
    #[doc = "Bits 24:31 - Multicore Sync 3"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_3(&mut self) -> MULTICORE_SYNC_3_W<GICD_ITARGETSR27_SPEC, 24> {
