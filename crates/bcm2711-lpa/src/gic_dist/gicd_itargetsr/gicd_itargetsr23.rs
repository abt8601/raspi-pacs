...
pub type R = crate::R<GICD_ITARGETSR23_SPEC>;
#[doc = "Register `GICD_ITARGETSR23` writer"]
pub type W = crate::W<GICD_ITARGETSR23_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int92(&mut self) -> INT92_W<GICD_ITARGETSR23_SPEC, 0> {
        INT92_W::new(self)
    }
    #[doc = "Bits 8:15 - Interrupt 93"]
    #[inline(always)]
    #[must_use]
    pub fn int93(&mut self) -> INT93_W<GICD_ITARGETSR23_SPEC, 8> {
        INT93_W::new(self)
    }
    #[doc = "Bits 16:23 - Interrupt 94"]
    #[inline(always)]
    #[must_use]
    pub fn int94(&mut self) -> INT94_W<GICD_ITARGETSR23_SPEC, 16> {
        INT94_W::new(self)
    }
    #[doc = "Bits 24:31 - Interrupt 95"]
    #[inline(always)]
    #[must_use]
    pub fn int95(&mut self) -> INT95_W<GICD_ITARGETSR23_SPEC, 24> {
        INT95_W::new(self)
    }
