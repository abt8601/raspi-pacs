...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dsi_0(&mut self) -> DSI_0_W<GICD_ITARGETSR33_SPEC, 0> {
        DSI_0_W::new(self)
    }
    #[doc = "Bits 8:15 - Pixel Valve 2"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_2(&mut self) -> PIXEL_VALVE_2_W<GICD_ITARGETSR33_SPEC, 8> {
        PIXEL_VALVE_2_W::new(self)
    }
    #[doc = "Bits 16:23 - Camera 0"]
    #[inline(always)]
    #[must_use]
    pub fn camera_0(&mut self) -> CAMERA_0_W<GICD_ITARGETSR33_SPEC, 16> {
        CAMERA_0_W::new(self)
    }
    #[doc = "Bits 24:31 - Camera 1"]
    #[inline(always)]
    #[must_use]
    pub fn camera_1(&mut self) -> CAMERA_1_W<GICD_ITARGETSR33_SPEC, 24> {
        CAMERA_1_W::new(self)
    }
