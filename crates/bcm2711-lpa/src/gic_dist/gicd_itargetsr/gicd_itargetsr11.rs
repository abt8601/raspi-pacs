...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int44(&mut self) -> INT44_W<GICD_ITARGETSR11_SPEC> {
        INT44_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 45"]
    #[inline(always)]
    #[must_use]
    pub fn int45(&mut self) -> INT45_W<GICD_ITARGETSR11_SPEC> {
        INT45_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 46"]
    #[inline(always)]
    #[must_use]
    pub fn int46(&mut self) -> INT46_W<GICD_ITARGETSR11_SPEC> {
        INT46_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 47"]
    #[inline(always)]
    #[must_use]
    pub fn int47(&mut self) -> INT47_W<GICD_ITARGETSR11_SPEC> {
        INT47_W::new(self, 24)
    }
