...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn h264_0(&mut self) -> H264_0_W<GICD_ITARGETSR25_SPEC, 0> {
        H264_0_W::new(self)
    }
    #[doc = "Bits 8:15 - H264 1"]
    #[inline(always)]
    #[must_use]
    pub fn h264_1(&mut self) -> H264_1_W<GICD_ITARGETSR25_SPEC, 8> {
        H264_1_W::new(self)
    }
    #[doc = "Bits 16:23 - H264 2"]
    #[inline(always)]
    #[must_use]
    pub fn h264_2(&mut self) -> H264_2_W<GICD_ITARGETSR25_SPEC, 16> {
        H264_2_W::new(self)
    }
    #[doc = "Bits 24:31 - JPEG"]
    #[inline(always)]
    #[must_use]
    pub fn jpeg(&mut self) -> JPEG_W<GICD_ITARGETSR25_SPEC, 24> {
        JPEG_W::new(self)
    }
