...
pub type HDMI_CEC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_ITARGETSR32_SPEC, u8, u8, 8, O>;
#[doc = "Field `HVS` reader - HVS"]
pub type HVS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `HVS` writer - HVS"]
pub type HVS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GICD_ITARGETSR32_SPEC, u8, u8, 8, O>;
...
pub type SDC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GICD_ITARGETSR32_SPEC, u8, u8, 8, O>;
impl R {
