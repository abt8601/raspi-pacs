...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hdmi_cec(&mut self) -> HDMI_CEC_W<GICD_ITARGETSR32_SPEC, 0> {
        HDMI_CEC_W::new(self)
    }
    #[doc = "Bits 8:15 - HVS"]
    #[inline(always)]
    #[must_use]
    pub fn hvs(&mut self) -> HVS_W<GICD_ITARGETSR32_SPEC, 8> {
        HVS_W::new(self)
    }
    #[doc = "Bits 16:23 - RPIVID"]
    #[inline(always)]
    #[must_use]
    pub fn rpivid(&mut self) -> RPIVID_W<GICD_ITARGETSR32_SPEC, 16> {
        RPIVID_W::new(self)
    }
    #[doc = "Bits 24:31 - SDC"]
    #[inline(always)]
    #[must_use]
    pub fn sdc(&mut self) -> SDC_W<GICD_ITARGETSR32_SPEC, 24> {
        SDC_W::new(self)
    }
