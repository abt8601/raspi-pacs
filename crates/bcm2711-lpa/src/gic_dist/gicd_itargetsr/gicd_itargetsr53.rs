...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int212(&mut self) -> INT212_W<GICD_ITARGETSR53_SPEC, 0> {
        INT212_W::new(self)
    }
    #[doc = "Bits 8:15 - Interrupt 213"]
    #[inline(always)]
    #[must_use]
    pub fn int213(&mut self) -> INT213_W<GICD_ITARGETSR53_SPEC, 8> {
        INT213_W::new(self)
    }
    #[doc = "Bits 16:23 - Interrupt 214"]
    #[inline(always)]
    #[must_use]
    pub fn int214(&mut self) -> INT214_W<GICD_ITARGETSR53_SPEC, 16> {
        INT214_W::new(self)
    }
    #[doc = "Bits 24:31 - Interrupt 215"]
    #[inline(always)]
    #[must_use]
    pub fn int215(&mut self) -> INT215_W<GICD_ITARGETSR53_SPEC, 24> {
        INT215_W::new(self)
    }
