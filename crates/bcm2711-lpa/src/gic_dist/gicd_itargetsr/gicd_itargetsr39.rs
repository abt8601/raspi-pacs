...
pub type CPG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GICD_ITARGETSR39_SPEC, u8, u8, 8, O>;
#[doc = "Field `RNG` reader - RNG"]
pub type RNG_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RNG` writer - RNG"]
pub type RNG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GICD_ITARGETSR39_SPEC, u8, u8, 8, O>;
...
pub type EMMC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GICD_ITARGETSR39_SPEC, u8, u8, 8, O>;
...
pub type ETH_PCIE_SECURE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, GICD_ITARGETSR39_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - CPG"]
    #[inline(always)]
