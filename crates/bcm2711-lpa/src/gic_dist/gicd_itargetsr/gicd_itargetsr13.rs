...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int52(&mut self) -> INT52_W<GICD_ITARGETSR13_SPEC, 0> {
        INT52_W::new(self)
    }
    #[doc = "Bits 8:15 - Interrupt 53"]
    #[inline(always)]
    #[must_use]
    pub fn int53(&mut self) -> INT53_W<GICD_ITARGETSR13_SPEC, 8> {
        INT53_W::new(self)
    }
    #[doc = "Bits 16:23 - Interrupt 54"]
    #[inline(always)]
    #[must_use]
    pub fn int54(&mut self) -> INT54_W<GICD_ITARGETSR13_SPEC, 16> {
        INT54_W::new(self)
    }
    #[doc = "Bits 24:31 - Interrupt 55"]
    #[inline(always)]
    #[must_use]
    pub fn int55(&mut self) -> INT55_W<GICD_ITARGETSR13_SPEC, 24> {
        INT55_W::new(self)
    }
