...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int200(&mut self) -> INT200_W<GICD_ITARGETSR50_SPEC> {
        INT200_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 201"]
    #[inline(always)]
    #[must_use]
    pub fn int201(&mut self) -> INT201_W<GICD_ITARGETSR50_SPEC> {
        INT201_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 202"]
    #[inline(always)]
    #[must_use]
    pub fn int202(&mut self) -> INT202_W<GICD_ITARGETSR50_SPEC> {
        INT202_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 203"]
    #[inline(always)]
    #[must_use]
    pub fn int203(&mut self) -> INT203_W<GICD_ITARGETSR50_SPEC> {
        INT203_W::new(self, 24)
    }
