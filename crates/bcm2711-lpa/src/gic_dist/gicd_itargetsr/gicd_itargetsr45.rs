...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int180(&mut self) -> INT180_W<GICD_ITARGETSR45_SPEC> {
        INT180_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 181"]
    #[inline(always)]
    #[must_use]
    pub fn int181(&mut self) -> INT181_W<GICD_ITARGETSR45_SPEC> {
        INT181_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 182"]
    #[inline(always)]
    #[must_use]
    pub fn int182(&mut self) -> INT182_W<GICD_ITARGETSR45_SPEC> {
        INT182_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 183"]
    #[inline(always)]
    #[must_use]
    pub fn int183(&mut self) -> INT183_W<GICD_ITARGETSR45_SPEC> {
