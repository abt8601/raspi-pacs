...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swi4(&mut self) -> SWI4_W<GICD_ITARGETSR19_SPEC, 0> {
        SWI4_W::new(self)
    }
    #[doc = "Bits 8:15 - Software interrupt 5"]
    #[inline(always)]
    #[must_use]
    pub fn swi5(&mut self) -> SWI5_W<GICD_ITARGETSR19_SPEC, 8> {
        SWI5_W::new(self)
    }
    #[doc = "Bits 16:23 - Software interrupt 6"]
    #[inline(always)]
    #[must_use]
    pub fn swi6(&mut self) -> SWI6_W<GICD_ITARGETSR19_SPEC, 16> {
        SWI6_W::new(self)
    }
    #[doc = "Bits 24:31 - Software interrupt 7"]
    #[inline(always)]
    #[must_use]
    pub fn swi7(&mut self) -> SWI7_W<GICD_ITARGETSR19_SPEC, 24> {
        SWI7_W::new(self)
    }
