...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int184(&mut self) -> INT184_W<GICD_ITARGETSR46_SPEC, 0> {
        INT184_W::new(self)
    }
    #[doc = "Bits 8:15 - Interrupt 185"]
    #[inline(always)]
    #[must_use]
    pub fn int185(&mut self) -> INT185_W<GICD_ITARGETSR46_SPEC, 8> {
        INT185_W::new(self)
    }
    #[doc = "Bits 16:23 - Interrupt 186"]
    #[inline(always)]
    #[must_use]
    pub fn int186(&mut self) -> INT186_W<GICD_ITARGETSR46_SPEC, 16> {
        INT186_W::new(self)
    }
    #[doc = "Bits 24:31 - Interrupt 187"]
    #[inline(always)]
    #[must_use]
    pub fn int187(&mut self) -> INT187_W<GICD_ITARGETSR46_SPEC, 24> {
        INT187_W::new(self)
    }
