...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int20(&mut self) -> INT20_W<GICD_ITARGETSR5_SPEC, 0> {
        INT20_W::new(self)
    }
    #[doc = "Bits 8:15 - Interrupt 21"]
    #[inline(always)]
    #[must_use]
    pub fn int21(&mut self) -> INT21_W<GICD_ITARGETSR5_SPEC, 8> {
        INT21_W::new(self)
    }
    #[doc = "Bits 16:23 - Interrupt 22"]
    #[inline(always)]
    #[must_use]
    pub fn int22(&mut self) -> INT22_W<GICD_ITARGETSR5_SPEC, 16> {
        INT22_W::new(self)
    }
    #[doc = "Bits 24:31 - Interrupt 23"]
    #[inline(always)]
    #[must_use]
    pub fn int23(&mut self) -> INT23_W<GICD_ITARGETSR5_SPEC, 24> {
        INT23_W::new(self)
    }
