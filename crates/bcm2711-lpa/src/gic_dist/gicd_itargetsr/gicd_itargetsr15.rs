...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int60(&mut self) -> INT60_W<GICD_ITARGETSR15_SPEC> {
        INT60_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 61"]
    #[inline(always)]
    #[must_use]
    pub fn int61(&mut self) -> INT61_W<GICD_ITARGETSR15_SPEC> {
        INT61_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 62"]
    #[inline(always)]
    #[must_use]
    pub fn int62(&mut self) -> INT62_W<GICD_ITARGETSR15_SPEC> {
        INT62_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 63"]
    #[inline(always)]
    #[must_use]
    pub fn int63(&mut self) -> INT63_W<GICD_ITARGETSR15_SPEC> {
        INT63_W::new(self, 24)
    }
