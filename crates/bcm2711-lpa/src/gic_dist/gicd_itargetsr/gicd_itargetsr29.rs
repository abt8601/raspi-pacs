...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_4(&mut self) -> DMA_4_W<GICD_ITARGETSR29_SPEC, 0> {
        DMA_4_W::new(self)
    }
    #[doc = "Bits 8:15 - DMA 5"]
    #[inline(always)]
    #[must_use]
    pub fn dma_5(&mut self) -> DMA_5_W<GICD_ITARGETSR29_SPEC, 8> {
        DMA_5_W::new(self)
    }
    #[doc = "Bits 16:23 - DMA 6"]
    #[inline(always)]
    #[must_use]
    pub fn dma_6(&mut self) -> DMA_6_W<GICD_ITARGETSR29_SPEC, 16> {
        DMA_6_W::new(self)
    }
    #[doc = "Bits 24:31 - OR of DMA 7 and 8"]
    #[inline(always)]
    #[must_use]
    pub fn dma_7_8(&mut self) -> DMA_7_8_W<GICD_ITARGETSR29_SPEC, 24> {
        DMA_7_8_W::new(self)
    }
