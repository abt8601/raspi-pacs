...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_3(&mut self) -> GPIO_3_W<GICD_ITARGETSR37_SPEC, 0> {
        GPIO_3_W::new(self)
    }
    #[doc = "Bits 8:15 - OR of all I2C"]
    #[inline(always)]
    #[must_use]
    pub fn i2c(&mut self) -> I2C_W<GICD_ITARGETSR37_SPEC, 8> {
        I2C_W::new(self)
    }
    #[doc = "Bits 16:23 - OR of all SPI"]
    #[inline(always)]
    #[must_use]
    pub fn spi(&mut self) -> SPI_W<GICD_ITARGETSR37_SPEC, 16> {
        SPI_W::new(self)
    }
    #[doc = "Bits 24:31 - PCM/I2S"]
    #[inline(always)]
    #[must_use]
    pub fn pcm_i2s(&mut self) -> PCM_I2S_W<GICD_ITARGETSR37_SPEC, 24> {
        PCM_I2S_W::new(self)
    }
