...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int216(&mut self) -> INT216_W<GICD_ITARGETSR54_SPEC, 0> {
        INT216_W::new(self)
    }
    #[doc = "Bits 8:15 - Interrupt 217"]
    #[inline(always)]
    #[must_use]
    pub fn int217(&mut self) -> INT217_W<GICD_ITARGETSR54_SPEC, 8> {
        INT217_W::new(self)
    }
    #[doc = "Bits 16:23 - Interrupt 218"]
    #[inline(always)]
    #[must_use]
    pub fn int218(&mut self) -> INT218_W<GICD_ITARGETSR54_SPEC, 16> {
        INT218_W::new(self)
    }
    #[doc = "Bits 24:31 - Interrupt 219"]
    #[inline(always)]
    #[must_use]
    pub fn int219(&mut self) -> INT219_W<GICD_ITARGETSR54_SPEC, 24> {
        INT219_W::new(self)
    }
