...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int40(&mut self) -> INT40_W<GICD_ITARGETSR10_SPEC> {
        INT40_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 41"]
    #[inline(always)]
    #[must_use]
    pub fn int41(&mut self) -> INT41_W<GICD_ITARGETSR10_SPEC> {
        INT41_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 42"]
    #[inline(always)]
    #[must_use]
    pub fn int42(&mut self) -> INT42_W<GICD_ITARGETSR10_SPEC> {
        INT42_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 43"]
    #[inline(always)]
    #[must_use]
    pub fn int43(&mut self) -> INT43_W<GICD_ITARGETSR10_SPEC> {
        INT43_W::new(self, 24)
    }
