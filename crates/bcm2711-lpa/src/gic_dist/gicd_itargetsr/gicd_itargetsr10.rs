...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int40(&mut self) -> INT40_W<GICD_ITARGETSR10_SPEC, 0> {
        INT40_W::new(self)
    }
    #[doc = "Bits 8:15 - Interrupt 41"]
    #[inline(always)]
    #[must_use]
    pub fn int41(&mut self) -> INT41_W<GICD_ITARGETSR10_SPEC, 8> {
        INT41_W::new(self)
    }
    #[doc = "Bits 16:23 - Interrupt 42"]
    #[inline(always)]
    #[must_use]
    pub fn int42(&mut self) -> INT42_W<GICD_ITARGETSR10_SPEC, 16> {
        INT42_W::new(self)
    }
    #[doc = "Bits 24:31 - Interrupt 43"]
    #[inline(always)]
    #[must_use]
    pub fn int43(&mut self) -> INT43_W<GICD_ITARGETSR10_SPEC, 24> {
        INT43_W::new(self)
    }
