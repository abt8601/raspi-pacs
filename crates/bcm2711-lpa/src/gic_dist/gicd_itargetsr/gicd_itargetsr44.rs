...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int176(&mut self) -> INT176_W<GICD_ITARGETSR44_SPEC> {
        INT176_W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 177"]
    #[inline(always)]
    #[must_use]
    pub fn int177(&mut self) -> INT177_W<GICD_ITARGETSR44_SPEC> {
        INT177_W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 178"]
    #[inline(always)]
    #[must_use]
    pub fn int178(&mut self) -> INT178_W<GICD_ITARGETSR44_SPEC> {
        INT178_W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 179"]
    #[inline(always)]
    #[must_use]
    pub fn int179(&mut self) -> INT179_W<GICD_ITARGETSR44_SPEC> {
