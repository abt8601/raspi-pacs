...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer(&mut self) -> TIMER_W<GICD_ISPENDR2_SPEC, 0> {
        TIMER_W::new(self)
    }
    #[doc = "Bit 1 - Mailbox"]
    #[inline(always)]
    #[must_use]
    pub fn mailbox(&mut self) -> MAILBOX_W<GICD_ISPENDR2_SPEC, 1> {
        MAILBOX_W::new(self)
    }
    #[doc = "Bit 2 - Doorbell 0"]
    #[inline(always)]
    #[must_use]
    pub fn doorbell0(&mut self) -> DOORBELL0_W<GICD_ISPENDR2_SPEC, 2> {
        DOORBELL0_W::new(self)
    }
    #[doc = "Bit 3 - Doorbell 1"]
    #[inline(always)]
    #[must_use]
    pub fn doorbell1(&mut self) -> DOORBELL1_W<GICD_ISPENDR2_SPEC, 3> {
        DOORBELL1_W::new(self)
    }
    #[doc = "Bit 4 - VPU0 halted"]
    #[inline(always)]
    #[must_use]
    pub fn vpu0_halted(&mut self) -> VPU0_HALTED_W<GICD_ISPENDR2_SPEC, 4> {
        VPU0_HALTED_W::new(self)
    }
    #[doc = "Bit 5 - VPU1 halted"]
    #[inline(always)]
    #[must_use]
    pub fn vpu1_halted(&mut self) -> VPU1_HALTED_W<GICD_ISPENDR2_SPEC, 5> {
        VPU1_HALTED_W::new(self)
    }
    #[doc = "Bit 6 - ARM address error"]
    #[inline(always)]
    #[must_use]
    pub fn arm_address_error(&mut self) -> ARM_ADDRESS_ERROR_W<GICD_ISPENDR2_SPEC, 6> {
        ARM_ADDRESS_ERROR_W::new(self)
    }
    #[doc = "Bit 7 - ARM AXI error"]
    #[inline(always)]
    #[must_use]
    pub fn arm_axi_error(&mut self) -> ARM_AXI_ERROR_W<GICD_ISPENDR2_SPEC, 7> {
        ARM_AXI_ERROR_W::new(self)
    }
    #[doc = "Bit 8 - Software interrupt 0"]
    #[inline(always)]
    #[must_use]
    pub fn swi0(&mut self) -> SWI0_W<GICD_ISPENDR2_SPEC, 8> {
        SWI0_W::new(self)
    }
    #[doc = "Bit 9 - Software interrupt 1"]
    #[inline(always)]
    #[must_use]
    pub fn swi1(&mut self) -> SWI1_W<GICD_ISPENDR2_SPEC, 9> {
        SWI1_W::new(self)
    }
    #[doc = "Bit 10 - Software interrupt 2"]
    #[inline(always)]
    #[must_use]
    pub fn swi2(&mut self) -> SWI2_W<GICD_ISPENDR2_SPEC, 10> {
        SWI2_W::new(self)
    }
    #[doc = "Bit 11 - Software interrupt 3"]
    #[inline(always)]
    #[must_use]
    pub fn swi3(&mut self) -> SWI3_W<GICD_ISPENDR2_SPEC, 11> {
        SWI3_W::new(self)
    }
    #[doc = "Bit 12 - Software interrupt 4"]
    #[inline(always)]
    #[must_use]
    pub fn swi4(&mut self) -> SWI4_W<GICD_ISPENDR2_SPEC, 12> {
        SWI4_W::new(self)
    }
    #[doc = "Bit 13 - Software interrupt 5"]
    #[inline(always)]
    #[must_use]
    pub fn swi5(&mut self) -> SWI5_W<GICD_ISPENDR2_SPEC, 13> {
        SWI5_W::new(self)
    }
    #[doc = "Bit 14 - Software interrupt 6"]
    #[inline(always)]
    #[must_use]
    pub fn swi6(&mut self) -> SWI6_W<GICD_ISPENDR2_SPEC, 14> {
        SWI6_W::new(self)
    }
    #[doc = "Bit 15 - Software interrupt 7"]
    #[inline(always)]
    #[must_use]
    pub fn swi7(&mut self) -> SWI7_W<GICD_ISPENDR2_SPEC, 15> {
        SWI7_W::new(self)
    }
    #[doc = "Bit 16 - Interrupt 80"]
    #[inline(always)]
    #[must_use]
    pub fn int80(&mut self) -> INT80_W<GICD_ISPENDR2_SPEC, 16> {
        INT80_W::new(self)
    }
    #[doc = "Bit 17 - Interrupt 81"]
    #[inline(always)]
    #[must_use]
    pub fn int81(&mut self) -> INT81_W<GICD_ISPENDR2_SPEC, 17> {
        INT81_W::new(self)
    }
    #[doc = "Bit 18 - Interrupt 82"]
    #[inline(always)]
    #[must_use]
    pub fn int82(&mut self) -> INT82_W<GICD_ISPENDR2_SPEC, 18> {
        INT82_W::new(self)
    }
    #[doc = "Bit 19 - Interrupt 83"]
    #[inline(always)]
    #[must_use]
    pub fn int83(&mut self) -> INT83_W<GICD_ISPENDR2_SPEC, 19> {
        INT83_W::new(self)
    }
    #[doc = "Bit 20 - Interrupt 84"]
    #[inline(always)]
    #[must_use]
    pub fn int84(&mut self) -> INT84_W<GICD_ISPENDR2_SPEC, 20> {
        INT84_W::new(self)
    }
    #[doc = "Bit 21 - Interrupt 85"]
    #[inline(always)]
    #[must_use]
    pub fn int85(&mut self) -> INT85_W<GICD_ISPENDR2_SPEC, 21> {
        INT85_W::new(self)
    }
    #[doc = "Bit 22 - Interrupt 86"]
    #[inline(always)]
    #[must_use]
    pub fn int86(&mut self) -> INT86_W<GICD_ISPENDR2_SPEC, 22> {
        INT86_W::new(self)
    }
    #[doc = "Bit 23 - Interrupt 87"]
    #[inline(always)]
    #[must_use]
    pub fn int87(&mut self) -> INT87_W<GICD_ISPENDR2_SPEC, 23> {
        INT87_W::new(self)
    }
    #[doc = "Bit 24 - Interrupt 88"]
    #[inline(always)]
    #[must_use]
    pub fn int88(&mut self) -> INT88_W<GICD_ISPENDR2_SPEC, 24> {
        INT88_W::new(self)
    }
    #[doc = "Bit 25 - Interrupt 89"]
    #[inline(always)]
    #[must_use]
    pub fn int89(&mut self) -> INT89_W<GICD_ISPENDR2_SPEC, 25> {
        INT89_W::new(self)
    }
    #[doc = "Bit 26 - Interrupt 90"]
    #[inline(always)]
    #[must_use]
    pub fn int90(&mut self) -> INT90_W<GICD_ISPENDR2_SPEC, 26> {
        INT90_W::new(self)
    }
    #[doc = "Bit 27 - Interrupt 91"]
    #[inline(always)]
    #[must_use]
    pub fn int91(&mut self) -> INT91_W<GICD_ISPENDR2_SPEC, 27> {
        INT91_W::new(self)
    }
    #[doc = "Bit 28 - Interrupt 92"]
    #[inline(always)]
    #[must_use]
    pub fn int92(&mut self) -> INT92_W<GICD_ISPENDR2_SPEC, 28> {
        INT92_W::new(self)
    }
    #[doc = "Bit 29 - Interrupt 93"]
    #[inline(always)]
    #[must_use]
    pub fn int93(&mut self) -> INT93_W<GICD_ISPENDR2_SPEC, 29> {
        INT93_W::new(self)
    }
    #[doc = "Bit 30 - Interrupt 94"]
    #[inline(always)]
    #[must_use]
    pub fn int94(&mut self) -> INT94_W<GICD_ISPENDR2_SPEC, 30> {
        INT94_W::new(self)
    }
    #[doc = "Bit 31 - Interrupt 95"]
    #[inline(always)]
    #[must_use]
    pub fn int95(&mut self) -> INT95_W<GICD_ISPENDR2_SPEC, 31> {
        INT95_W::new(self)
    }
