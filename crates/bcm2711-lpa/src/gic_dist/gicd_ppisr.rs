...
pub type ID29_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ID30_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `ID31` reader - nLEGACYIRQ signal"]
pub type ID31_R = crate::BitReader;
#[doc = "Field `ID31` writer - nLEGACYIRQ signal"]
pub type ID31_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn id25(&mut self) -> ID25_W<GICD_PPISR_SPEC, 9> {
        ID25_W::new(self)
    }
    #[doc = "Bit 10 - Hypervisor timer event"]
    #[inline(always)]
    #[must_use]
    pub fn id26(&mut self) -> ID26_W<GICD_PPISR_SPEC, 10> {
        ID26_W::new(self)
    }
    #[doc = "Bit 11 - Virtual timer event"]
    #[inline(always)]
    #[must_use]
    pub fn id27(&mut self) -> ID27_W<GICD_PPISR_SPEC, 11> {
        ID27_W::new(self)
    }
    #[doc = "Bit 12 - nLEGACYFIQ signal"]
    #[inline(always)]
    #[must_use]
    pub fn id28(&mut self) -> ID28_W<GICD_PPISR_SPEC, 12> {
        ID28_W::new(self)
    }
    #[doc = "Bit 13 - Secure physical timer event"]
    #[inline(always)]
    #[must_use]
    pub fn id29(&mut self) -> ID29_W<GICD_PPISR_SPEC, 13> {
        ID29_W::new(self)
    }
    #[doc = "Bit 14 - Non-secure physical timer event"]
    #[inline(always)]
    #[must_use]
    pub fn id30(&mut self) -> ID30_W<GICD_PPISR_SPEC, 14> {
        ID30_W::new(self)
    }
    #[doc = "Bit 15 - nLEGACYIRQ signal"]
    #[inline(always)]
    #[must_use]
    pub fn id31(&mut self) -> ID31_W<GICD_PPISR_SPEC, 15> {
        ID31_W::new(self)
    }
