...
pub type SET54_W<'a, REG, const O: u8> = crate::BitWriter1S<'a, REG, O>;
#[doc = "Field `SET55` writer - Set 55"]
pub type SET55_W<'a, REG, const O: u8> = crate::BitWriter1S<'a, REG, O>;
#[doc = "Field `SET56` writer - Set 56"]
pub type SET56_W<'a, REG, const O: u8> = crate::BitWriter1S<'a, REG, O>;
#[doc = "Field `SET57` writer - Set 57"]
pub type SET57_W<'a, REG, const O: u8> = crate::BitWriter1S<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn set54(&mut self) -> SET54_W<GPSET1_SPEC, 22> {
        SET54_W::new(self)
    }
    #[doc = "Bit 23 - Set 55"]
    #[inline(always)]
    #[must_use]
    pub fn set55(&mut self) -> SET55_W<GPSET1_SPEC, 23> {
        SET55_W::new(self)
    }
    #[doc = "Bit 24 - Set 56"]
    #[inline(always)]
    #[must_use]
    pub fn set56(&mut self) -> SET56_W<GPSET1_SPEC, 24> {
        SET56_W::new(self)
    }
    #[doc = "Bit 25 - Set 57"]
    #[inline(always)]
    #[must_use]
    pub fn set57(&mut self) -> SET57_W<GPSET1_SPEC, 25> {
        SET57_W::new(self)
    }
