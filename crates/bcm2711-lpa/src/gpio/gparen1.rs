...
pub type AREN54_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type AREN55_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type AREN56_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type AREN57_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aren54(&mut self) -> AREN54_W<GPAREN1_SPEC, 22> {
        AREN54_W::new(self)
    }
    #[doc = "Bit 23 - Async rising enabled 55"]
    #[inline(always)]
    #[must_use]
    pub fn aren55(&mut self) -> AREN55_W<GPAREN1_SPEC, 23> {
        AREN55_W::new(self)
    }
    #[doc = "Bit 24 - Async rising enabled 56"]
    #[inline(always)]
    #[must_use]
    pub fn aren56(&mut self) -> AREN56_W<GPAREN1_SPEC, 24> {
        AREN56_W::new(self)
    }
    #[doc = "Bit 25 - Async rising enabled 57"]
    #[inline(always)]
    #[must_use]
    pub fn aren57(&mut self) -> AREN57_W<GPAREN1_SPEC, 25> {
        AREN57_W::new(self)
    }
