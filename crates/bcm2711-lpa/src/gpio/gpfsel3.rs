...
pub type FSEL30_R = crate::FieldReader<u8, FSEL30_A>;
...
pub type FSEL30_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL30_A, 3, O>;
...
pub type FSEL31_R = crate::FieldReader<u8, FSEL31_A>;
...
pub type FSEL31_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL31_A, 3, O>;
...
pub type FSEL32_R = crate::FieldReader<u8, FSEL32_A>;
...
pub type FSEL32_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL32_A, 3, O>;
...
pub type FSEL33_R = crate::FieldReader<u8, FSEL33_A>;
...
pub type FSEL33_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL33_A, 3, O>;
...
pub type FSEL34_R = crate::FieldReader<u8, FSEL34_A>;
...
pub type FSEL34_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL34_A, 3, O>;
...
pub type FSEL35_R = crate::FieldReader<u8, FSEL35_A>;
...
pub type FSEL35_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL35_A, 3, O>;
...
pub type FSEL36_R = crate::FieldReader<u8, FSEL36_A>;
...
pub type FSEL36_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL36_A, 3, O>;
...
pub type FSEL37_R = crate::FieldReader<u8, FSEL37_A>;
...
pub type FSEL37_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL37_A, 3, O>;
...
pub type FSEL38_R = crate::FieldReader<u8, FSEL38_A>;
...
pub type FSEL38_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL38_A, 3, O>;
...
pub type FSEL39_R = crate::FieldReader<u8, FSEL39_A>;
...
pub type FSEL39_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL39_A, 3, O>;
